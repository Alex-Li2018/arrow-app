...
export const intersectLineAndLine = (lineA, lineB) => {
...
export const intersectLineAndCircle = (line, circle, naturalPosition) => {
    if (isVertical(line)) {
...
export const intersectCircleAndCircle = (circleA, circleB, naturalPosition) => {
